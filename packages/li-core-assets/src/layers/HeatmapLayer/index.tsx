...
const ICON = () => (
  <svg viewBox="0 0 64 64" width="56px" height="56px" style={{ fill: 'currentcolor' }}>
    ...
    <path
      ...
      style={{ opacity: '0.36' }}
    />
    <path d="M33,44.79a9.53,9.53,0,0,1-1.13,1.14C32.3,45.53,32.67,45.15,33,44.79Z" style={{ opacity: '0.36' }} />
    <path d="M25.83,44.13c-3.82,1.55-8,0-9.33-3.46s.65-7.55,4.45-9.1,8,0,9.33,3.46S29.63,42.57,25.83,44.13Z" />
    <path d="M31.81,46a.09.09,0,0,1,0,0h0Z" />
  </svg>
);

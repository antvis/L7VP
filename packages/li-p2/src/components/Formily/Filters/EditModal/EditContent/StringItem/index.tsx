...
import type { FilterString, OptionType } from '../../../type';
...
const StringItem: React.FC<StringItemProps> = (props) => {
  const prefixCls = usePrefixCls('formily-filters-edit-modal-right-string-item');
  ...
  return wrapSSR(
    <>
      <div className={cls(`${prefixCls}__filter`, hashId)}>
        ...
        <Radio.Group value={value.otherParams.radioType} onChange={(e) => onTypeChange(e.target.value)}>
